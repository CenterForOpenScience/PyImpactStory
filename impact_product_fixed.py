# Changed Product to get rid of parsing methods 
...
class Dataset(Product):
    ...
    def __repr__(self):
        return "Title: " + self.tiid + "Published Date: " + str(self._published_date)\
                + "\nRepository: " + str(self._repository) + "\n OA Journal: " + str(self._is_oa_journal)
...
class Figure(Product):
    ...
    def __repr__(self):
        return "Published Date: " + str(self._published_date)\
                + "\nRepository: " + str(self._repository) + "\n OA Journal: " + str(self._is_oa_journal)
